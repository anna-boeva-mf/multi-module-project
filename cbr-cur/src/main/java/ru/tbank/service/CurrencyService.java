...
public class CurrencyService {
    ...
    public CurrencyRateResponse getCurrencyRate(String code) {
        ...
        if (response == null) throw new CurrencyNotFoundException("The currency " + code + " is not included in the list of the Central Bank of the Russian Federation");
        return response;
    }
    ...
    public CurrencyConverterResponse convertCurrency(CurrencyConverterRequest request) {
        ...
        if (amount <= 0) throw new BadRequestException("Parameter amount must be greater than zero");
